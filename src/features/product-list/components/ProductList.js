          ...
          <section aria-labelledby="products-heading" className="pb-12">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                {/* product page */}
                <div className="bg-white">
                  <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-4 lg:pt-6">
                    <h2 className="text-4xl font-bold tracking-tight text-gray-900">
                      Products
                    </h2>

                    <div className="mt-6 grid grid-cols-1 gap-x-5 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                      {products.map((product) => (
                        <Link to="/product-detail">
                          <div key={product.id} className="h-full w-full rounded p-2 drop-shadow-xl overflow-hidden group relative border-2 border-gray-200">
                            ...
                            <div className="mt-4 p-2 flex justify-between">
                              <div>
                                ...
                                <p className="mt-1 text- text-sm text-gray-500">
                                  ...
                                  <StarIcon className="w-4 h-4 fill-yellow-500 inline mb-1" />
                                </p>
                              </div>
                              <div>
                                ...
                                <p className="line-through text-sm font-medium text- text-gray-500">
                                  ${product.price}
                                </p>
                              </div>
                            </div>
                            <p className="text-sm px-1 font-medium text-gray-600">
                              {product.description}
                            </p>
                          </div>
                        </Link>
